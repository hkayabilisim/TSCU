function [fdobj, df, gcv, coef, SSE] = ...
             data2fd_new(argvals, y, basisobj, nderiv, lambda, fdnames)
...
%  check whether ARGVALS and Y should be swapped
 ...
 [y, argvals] = argvalsy_swap(y, argvals, basisobj);
 ...
 if length(argvals) ~= ydim(1) 
     error(['Length of first dimension of Y', ...
            ' is not equal to length of ARGVALS.']);
 end
